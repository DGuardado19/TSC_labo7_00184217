...
enum parameters {taf ,kappa ,labda, psi_x, psi_y , delta, ita};
...
class mesh{
    ...
    public:
        void setParameters(float u_bar,float nu, float rho, float f_x, float f_y, float deltas, float itas){
            //taf ,kappa ,labda, psi_x, psi_y , delta, ita
            parameters[taf]=u_bar;
            parameters[kappa]=nu;
            parameters[labda]=rho;
            parameters[psi_x]=f_x;
            parameters[psi_y]=f_y;
            parameters[delta]=deltas;
            parameters[ita]= itas ;
        }
